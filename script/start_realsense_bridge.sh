...
OUTPUT_COLOR_TOPIC="${OUTPUT_COLOR_TOPIC:-/omnimorph/camera/color/image_raw}"
OUTPUT_DEPTH_TOPIC="${OUTPUT_DEPTH_TOPIC:-/omnimorph/camera/depth/image_raw}"
OUTPUT_COLOR_INFO_TOPIC="${OUTPUT_COLOR_INFO_TOPIC:-/omnimorph/camera/color/camera_info}"
OUTPUT_DEPTH_INFO_TOPIC="${OUTPUT_DEPTH_INFO_TOPIC:-/omnimorph/camera/depth/camera_info}"
OUTPUT_COLOR_COMPRESSED_TOPIC="${OUTPUT_COLOR_COMPRESSED_TOPIC:-/omnimorph/camera/color/image_raw/compressed}"
OUTPUT_DEPTH_COMPRESSED_TOPIC="${OUTPUT_DEPTH_COMPRESSED_TOPIC:-/omnimorph/camera/depth/image_raw/compressed}"
OUTPUT_FEATURE_TOPIC="${OUTPUT_FEATURE_TOPIC:-/omnimorph/camera/features}"
