...
```bash
grep -E 'ONNXRUNTIME_(INCLUDE_DIR|LIBRARY|ROOT)' /home/edify/Code/jc01_deploy/build/rl_master/CMakeCache.txt
```
...
ldd /home/edify/Code/jc01_deploy/install/rl_master/lib/rl_master/librl_master_runtime.so | grep onnxruntime
ldd /home/edify/Code/jc01_deploy/install/mujoco_sim2sim/lib/mujoco_sim2sim/mujoco_sim_bridge | grep onnxruntime
```
...
cd /home/edify/Code/jc01_deploy
...
```bash
readelf -d /home/edify/Code/jc01_deploy/install/rl_master/lib/rl_master/librl_master_runtime.so | grep -E 'RPATH|RUNPATH'
readelf -d /home/edify/Code/jc01_deploy/install/rl_master/lib/rl_master/RL_solver | grep -E 'RPATH|RUNPATH'
readelf -d /home/edify/Code/jc01_deploy/install/mujoco_sim2sim/lib/mujoco_sim2sim/mujoco_sim_bridge | grep -E 'RPATH|RUNPATH'
```
