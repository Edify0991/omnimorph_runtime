...
- [sim2sim_runtime_environment_notes.md](${OMNIMORPH_RUNTIME_ROOT}/src/omnimorph_sim2sim/mujoco_sim2sim/docs/sim2sim_runtime_environment_notes.md)
...
- `enable_state_telemetry`: enable low-frequency asynchronous `/omnimorph/rl/state`
- `state_telemetry_hz`: publish rate for asynchronous `/omnimorph/rl/state`
...
- `/omnimorph/rl/state` (debug / monitoring)
- `/omnimorph/rl/runtime_command` (optional test-injection path such as `joint_motor_test`)

The legacy `/omnimorph/rl/command` hop is removed. Use `/omnimorph/rl/runtime_command`
...
- `/omnimorph/rl/state` is telemetry, not a control-path publish
...
- [jc01_fullbody_engineai_walk_passive_check.xml](${OMNIMORPH_RUNTIME_ROOT}/src/omnimorph_sim2sim/mujoco_sim2sim/models/jc01_fullbody_engineai_walk_passive_check.xml)
