...
- standard launcher script:
  [`script/start_imu_yesense.sh`](/home/edify/Code/jc01_deploy/script/start_imu_yesense.sh)
...
- For full real-robot startup order, see:
  [`dds_sim2real_deploy_guide.md`](/home/edify/Code/jc01_deploy/src/humanoid_rl_controller/rl_master/docs/dds_sim2real_deploy_guide.md)
