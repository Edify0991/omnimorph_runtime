...
- profile section: [`rl_cfg_jc01.yaml`](${OMNIMORPH_RUNTIME_ROOT}/src/omnimorph_rl_controller/rl_master/config/rl_cfg_jc01.yaml)
  Search for `engineai_full_body_example`
- observation manifest: [`observation_manifest_full_body_example.yaml`](${OMNIMORPH_RUNTIME_ROOT}/src/omnimorph_rl_controller/rl_master/config/observation_manifest_full_body_example.yaml)
