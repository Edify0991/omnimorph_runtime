...
- encode: [`dds_protocol.cpp`](${OMNIMORPH_RUNTIME_ROOT}/src/omnimorph_rl_controller/rl_master/dds_protocol.cpp:103)
- decode: [`dds_protocol.cpp`](${OMNIMORPH_RUNTIME_ROOT}/src/omnimorph_rl_controller/rl_master/dds_protocol.cpp:130)
...
- encode: [`dds_protocol.cpp`](${OMNIMORPH_RUNTIME_ROOT}/src/omnimorph_rl_controller/rl_master/dds_protocol.cpp:186)
- decode: [`dds_protocol.cpp`](${OMNIMORPH_RUNTIME_ROOT}/src/omnimorph_rl_controller/rl_master/dds_protocol.cpp:219)
