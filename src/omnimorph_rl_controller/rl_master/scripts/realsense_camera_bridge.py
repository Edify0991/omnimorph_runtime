...
class StandardizedCameraBridge(Node):
    def __init__(self) -> None:
        ...
        self.declare_parameter("output_color_topic", "/omnimorph/camera/color/image_raw")
        self.declare_parameter("output_depth_topic", "/omnimorph/camera/depth/image_raw")
        self.declare_parameter("output_color_info_topic", "/omnimorph/camera/color/camera_info")
        self.declare_parameter("output_depth_info_topic", "/omnimorph/camera/depth/camera_info")
        self.declare_parameter("output_color_compressed_topic", "/omnimorph/camera/color/image_raw/compressed")
        self.declare_parameter("output_depth_compressed_topic", "/omnimorph/camera/depth/image_raw/compressed")
        self.declare_parameter("output_feature_topic", "/omnimorph/camera/features")
