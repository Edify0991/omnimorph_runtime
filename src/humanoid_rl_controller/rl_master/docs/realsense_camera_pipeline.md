...
2. `realsense_camera_bridge.py`:
   republishes those topics into the humanoid runtime's standardized topic set,
...
- `/humanoid/camera/color/camera_info`
- `/humanoid/camera/color/image_raw/compressed`
- `/humanoid/camera/depth/image_raw`
- `/humanoid/camera/depth/camera_info`
- `/humanoid/camera/depth/image_raw/compressed`
- `/humanoid/camera/features`
...
external_observations:
  - name: camera_features
    dim: 8
    topic: /humanoid/camera/features
```
