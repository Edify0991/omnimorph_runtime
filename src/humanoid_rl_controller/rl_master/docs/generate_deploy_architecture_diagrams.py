...
def build_text(lang: str) -> dict[str, object]:
    if lang == "zh":
        return {
            ...
            "nodes": {
                "operator": ("操作员 GUI / 脚本", "humanoid_ops_gui.py、手柄、shell 工具"),
                "topics": ("DDS / ROS 2 控制话题", "/humanoid/rl/teleop\n/humanoid/rl/mode_control"),
                "imu": ("IMU 输入", "/imu/yesense\n仅实机路径使用"),
                "cfg": ("模式与机器人配置", "rl_cfg.yaml + profiles/*.yaml\n关节顺序、增益、限幅、策略组"),
                ...
                "shm": ("电机共享内存 I/O", "MotorShmIo + 运动学转换\n读关节反馈 / 写目标与力矩"),
                ...
                "telemetry": ("可观测输出", "/humanoid/rl/state\nviewer_frame / inspector\nruntime log / MCAP"),
            },
            "labels": {
                "control": "速度 + 模式",
                "mode": "模式合同",
    ...
    return {
        ...
        "nodes": {
            "operator": ("Operator GUI / Scripts", "humanoid_ops_gui.py, joystick, shell tools"),
            "topics": ("DDS / ROS 2 Control Topics", "/humanoid/rl/teleop\n/humanoid/rl/mode_control"),
            "imu": ("IMU Input", "/imu/yesense\nreal robot path only"),
            "cfg": ("Mode and Robot Config", "rl_cfg.yaml + profiles/*.yaml\njoint order, gains, limits, policy groups"),
            ...
            "shm": ("Motor Shared Memory I/O", "MotorShmIo + kinematic conversion\nread joint feedback / write targets and torque"),
            ...
            "telemetry": ("Observable Outputs", "/humanoid/rl/state\nviewer_frame / inspector\nruntime log / MCAP"),
        },
        "labels": {
